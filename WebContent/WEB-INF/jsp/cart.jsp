...
<div class="container cart">
				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath }/cart_removeCart.action?pid=<s:property value="#cartItem.product.id"/>" class="delete">删除</a>
							</td>
						</tr>
						</s:iterator>
					</tbody>
	...
	<s:else>
		<div class="span24">
			<div class="step step1"  style="margin: 70px 370px;">
				<span><h2>购物车为空，请添加商品</h2></span>
			</div>
		</div>	
	</s:else>
</div>
